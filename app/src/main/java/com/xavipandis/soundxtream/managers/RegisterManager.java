...
import com.xavipandis.soundxtream.exceptions.CustomTokenException;
import com.xavipandis.soundxtream.model.User;
import com.xavipandis.soundxtream.services.UserService;
    ...
    public synchronized void createUser(User user, final RegisterCallback registerCallback) {
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                if (t instanceof CustomTokenException){
